...
**2026년 노트:** 이 글은 지금의 AI 물결이 본격화되기 전에 쓴 글입니다. 그 사이 상황은 제가 묘사한 것보다 훨씬 더 빠르게 변했습니다. 제가 주장했던 'How(어떻게)'에서 'Why(왜)'로의 전환? AI는 그 너머 — **'What(무엇을 만들 것인가)'** 까지 밀어붙이고 있습니다. AI 코딩의 등장으로 구현 비용이 급격히 낮아지면서, '마이크로(How)'는 예상보다 훨씬 빠르게 범용화되고 있습니다. 'Why'를, 그리고 특히 'What should we build?'를 묻는 '매크로' 관점은 이제 단순히 가치 있는 것을 넘어 필수가 되었습니다. 이 글의 핵심 주장은 오히려 지금 더 유효하고, 어쩌면 당시엔 충분히 강하게 말하지 못했을 수도 있습니다. 그래서 다시 공유합니다.
